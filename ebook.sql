...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 11 oct. 2019 à 22:58
...
(11, 'Alan', 'DeMiannay', '5 rue du bidon', '53000', 'Laval', '2000-02-20', '0695282942', 'alan.demiannay@gmail.com', 'AlanD', 'pd');
...
INSERT INTO `produits` (`IdProd`, `NumCat`, `LibProd`, `PrixProd`, `QteProd`, `DescProd`) VALUES
(1, 1, 'Caillou', 2.54, 150, 'Extraction respectueuse de la nature'),
(2, 4, 'Uranium', 350, 50, 'Necessite un partenariat'),
(3, 6, 'Steak de soja', 12, 1100, 'Pour stimulez vos papilles tout en respectant la nature  !');
